...
# 输入线圈参数
T1 = 78  # 温度
r_A1 = 5e-5  # 交流电阻随频率变化曲线
Lin = 344.618e-6  # 输入线圈等效电感
Cin = 2.26713e-9  # 输入线圈等效电容
Rin = 0.3437  # 输入线圈等效电阻
# 外接电感和电容参数
T2 = 298  # 温度
r_A2 = 0  # 交流电阻随频率变化曲线
...
# 磁场转换线圈参数
T3 = 298  # 温度
r_A3 = 0.61 / 777124  # 交流电阻随频率变化曲线
Lload = 1e-6  # 磁场转换线圈等效电感
Cload = 1e-5  # 磁场转换线圈等效电容
Rload = 0.5e-1  # 磁场转换线圈等效电阻
...
OutDict['noises'][0]['Rdc']         = 0.3437 # Om
OutDict['noises'][0]['Rslope']      = 5e-5*1e6 # /MHz
...
OutDict['noises'].append({})
OutDict['noises'][1]['Rdc']         = 0.5e-1 # Om
OutDict['noises'][1]['Rslope']      = 0.61 / 777124*1e6 # /MHz
